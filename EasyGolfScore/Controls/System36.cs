...
{
    public partial class System36 : UserControl
    {
        private static System36 _instance;
        public static System36 Instance
        {
            get { 
                if(_instance == null)
                {
                    _instance = new System36();
                }
                return _instance; 
            }
        }
        ...
        private void System36_Load(object sender, EventArgs e)
        {
            if (!DesignMode)
            {
        ...
        private int CalculateHandicap(int total)
        {
            var handi = 36 - total;
            return handi;
        }
        private void calculateMark()
        {
            ...
            for (int j = 0; j < rowcount; j++)
            {
                ...
                var Handi = CalculateHandicap(um.TotalMark);
        ...
        private void calculateMarkSort()
        {
            ...
            for (int i = 0; i < row; i++)
            {
                ...
                sm.HS = int.Parse(dgStroke[column - 3, i].Value.ToString());
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            using (var pk = new ExcelPackage())
            {
                ...
                sheet.Cells[1, 1].Value = "Golf Marks by System 36";
