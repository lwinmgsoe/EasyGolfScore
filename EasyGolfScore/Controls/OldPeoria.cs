...
{
    public partial class OldPeoria : UserControl
    {
        private static OldPeoria _instance;
        public static OldPeoria Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new OldPeoria();
                }
                return _instance;
            }
        }
        ...
        private void OldPeoria_Load(object sender, EventArgs e)
        {
            if (!DesignMode)
            {
        ...
        private void calculateMark()
        {
            ...
            for (int j = 0; j < rowcount; j++)
            {
                ...
                if (selectedHoles == null || selectedHoles.Count < 6)
                {
                    MessageBox.Show("Please select holes", "selece 6 holes", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
